    ...
    <div className={cls.join(" ")} onClick={() => openOrder(order.id)}>
      ...
      <div className="order-tail">
        <p className="order-price">
          {soon === "fire" &&
          <span title='Горящая сделка - для совершения сделки осталось менее двух часов.
          Оплата по повышенному коэффициенту.'><FaFireAlt color="#FC0D1C"/></span>}
          {soon === "urgent" &&
          <span title='Внимание! До завершения сделки осталось мало времени. Поторопитесь!'>
          <IoMdAlert color="#FC0D1C"/></span>}
